...
import { Plus, Calendar as CalendarIcon, Trash2, Clock, ChevronUp, ArrowBigDown } from 'lucide-react';
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2 mb-3">
        ...
        <div className="flex items-center justify-center">
          <Button
            ...
            <ArrowBigDown className="w-5 h-5 text-success bg-destructive rounded-2xl" />
            }
          </Button>
        </div>
